        ...
        {activeTab === TabView.SETTINGS && (
            <div className="p-6 space-y-4">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-xl p-4 shadow-sm">
                    <div className="font-bold mb-3 flex items-center gap-2"><Key size={18}/> AI Key</div>
                    <input type="password" value={customApiKey} onChange={(e) => setCustomApiKey(e.target.value)} placeholder="Gemini API Key..." className="w-full bg-slate-50 dark:bg-slate-800 border rounded-lg px-3 py-2 text-sm mb-3 outline-none focus:border-blue-500" />
